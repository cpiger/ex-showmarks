...
" hi default ShowMarksHLl ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=#008080 gui=bold
" hi default ShowMarksHLu ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=#008080 gui=bold
" hi default ShowMarksHLo ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=#008080 gui=bold
" hi default ShowMarksHLm ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=#008080 gui=bold

" hi default ShowMarksHLl ctermfg=white ctermbg=blue guifg=wheat guibg=peru
" hi default ShowMarksHLu ctermfg=white ctermbg=blue guifg=wheat guibg=peru
